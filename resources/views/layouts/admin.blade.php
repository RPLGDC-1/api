    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper">
              <h2 class="text-lg mx-2 mt-2">Dunia Belanja</h2>
            </div>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li>
                        <a class="submenu-title" href="dashboard-02.html#"
                          >Form Controls<span class="sub-arrow"><i class="fa fa-angle-right"></i></span
                        ></a>
                      ...
                      <li>
                        <a class="submenu-title" href="dashboard-02.html#"
                          >Form Widgets<span class="sub-arrow"><i class="fa fa-angle-right"></i></span
                        ></a>
                        <ul class="nav-sub-childmenu submenu-content">
                      ...
                      <li>
                        <a class="submenu-title" href="dashboard-02.html#"
                          >Form layout<span class="sub-arrow"><i class="fa fa-angle-right"></i></span
                        ></a>
                        <ul class="nav-sub-childmenu submenu-content">
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li>
                        <a class="submenu-title" href="dashboard-02.html#"
                          >Bootstrap Tables<span class="sub-arrow"><i class="fa fa-angle-right"></i></span
                        ></a>
                        <ul class="nav-sub-childmenu submenu-content">
                      ...
                      <li>
                        <a class="submenu-title" href="dashboard-02.html#"
                          >Data Tables<span class="sub-arrow"><i class="fa fa-angle-right"></i></span
                        ></a>
                        <ul class="nav-sub-childmenu submenu-content">
                      ...
                      <li>
                        <a class="submenu-title" href="dashboard-02.html#"
                          >Ex. Data Tables<span class="sub-arrow"><i class="fa fa-angle-right"></i></span
                        ></a>
                        <ul class="nav-sub-childmenu submenu-content">
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      ...
                      <li>
                        <a class="submenu-title" href="dashboard-02.html#"
                          >Tabs<span class="sub-arrow"><i class="fa fa-angle-right"></i></span
                        ></a>
                        <ul class="nav-sub-childmenu submenu-content">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="http://admin.pixelstrap.com/zeta/starter-kit/index.html" target="_blank">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
