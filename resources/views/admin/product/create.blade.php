          ...
          <div class="date-picker">
            <form class="theme-form" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3 row g-3">
                ...
                <div class="col-xl-5 col-sm-9">
                  <div class="input-group  @error('image') is-invalid border-danger @enderror">
                    <input type="file" class="dropify " name="image" data-default-file="" data-show-remove="false" data-allowed-file-extensions="png jpg jpeg" data-max-file-size="1M" />
                    @error('image')
              ...
              <div class="mb-3 row g-3">
                ...
                <div class="col-xl-5 col-sm-9">
                  <div class="input-group">
                    <input class="form-control @error('stock') is-invalid border-danger @enderror" name="stock" type="number" placeholder="Enter stock" value="{{ old('stock') }}">
                    @error('stock')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
              ...
              <div class="mb-3 row g-3">
                ...
                <div class="col-xl-5 col-sm-9">
                  <div class="input-group">
                    <input class="form-control @error('price') is-invalid border-danger @enderror numeric" name="price" type="text" placeholder="Enter price" value="{{ old('price') }}">
                    @error('price')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
              ...
              <div class="mb-3 row g-3">
                ...
                <div class="col-xl-5 col-sm-9">
                  <div class="input-group">
                    <input class="form-control @error('selling_price') is-invalid border-danger @enderror numeric" name="selling_price" type="text" placeholder="Enter Selling price" value="{{ old('selling_price') }}">
                    @error('selling_price')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="input-group">
                    <select class="form-select @error('category_id') is-invalid border-danger @enderror" name="category_id">
                      ...
                      @foreach ($categories as $row)
                        <option value="{{ $row->id }}" {{ $row->id == old('category_ud') ? 'selected' : '' }}>{{ $row->name }}</option>
                      @endforeach
                    </select>
                    @error('category_id')
                      <div class="invalid-feedback">{{ $message }}</div>
              ...
              <div class="mb-3 row g-3">
                ...
                <div class="col-xl-5 col-sm-9">
                  <div class="input-group">
                    <textarea class="form-control @error('description') is-invalid border-danger @enderror" placeholder="Enter description" name="description" rows="4">{{ old('description') }}</textarea>
                    @error('description')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
