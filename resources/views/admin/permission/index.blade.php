...
@section('content')
  <div class="container-fluid">
    <div class="page-title">
      <div class="d-flex justify-content-between">
        ...
        <div class="">
          <a class="btn btn-primary" href="javascript:void(0)" onclick="handleCreate()" data-bs-toggle="modal" data-bs-target="#crud-modal">Add Permissions</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- CRUD Modal -->
<form action="{{ route('permissions.store') }}" method="POST" id="crud-form">
  @csrf
  @method('POST')
